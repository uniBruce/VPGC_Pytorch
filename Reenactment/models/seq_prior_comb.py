...
class PriorTrans(nn.Module):
    def __init__(self, *, dim=256, batch_size=4, depth=4, heads=4, dim_head=64, mlp_dim=256, dropout=0.1):
        super().__init__()
