...
from taming.modules.vqvae.quantize import GroupVectorQuantizer as VectorQuantizer
...
class VQGROUPModel(pl.LightningModule):
    def __init__(self,
                 ddconfig,
                 lossconfig,
                 n_embed,
        ...
        self.quant_conv = torch.nn.Conv2d(ddconfig["z_channels"], self.group * embed_dim, 1)
        self.post_quant_conv = torch.nn.Conv2d(self.group * embed_dim, ddconfig["z_channels"], 1)
